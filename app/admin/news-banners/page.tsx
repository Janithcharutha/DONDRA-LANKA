...
export default function NewsBannersPage() {
  ...
  const handleDelete = async (id: string) => {
    try {
      ...
      if (!response.ok) throw new Error('Failed to delete news banner')

      setNewsBanners(prev => prev.filter(banner => banner._id !== id))
      toast({
        title: "Success",
        description: "News banner deleted successfully",
      })
    } catch (error) {
      console.error('Error:', error)
      toast({
        title: "Error",
        description: "Failed to delete news banner",
        variant: "destructive",
      })
    }
  }
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              This will permanently delete the news banner. This action cannot be undone.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
